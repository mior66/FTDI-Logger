...
function init() {
    ...
    // Set up test plan print button event listener
    const printTestPlanButton = document.getElementById('print-test-plan');
    if (printTestPlanButton) {
        printTestPlanButton.addEventListener('click', printTestPlan);
    }
    ...
    rows.forEach((row, index) => {
        ...
        htmlContent += `
            <div class="test-case">
                ...
                ${description ? `<div class="test-case-info"><span class="metadata-label">Description:</span> ${description}</div>` : ''}
        `;
